...
export EXP_NAME="1.5b_INTERLEAVE"
...
python -u -m verl.src_interleave_sft.main_mix_ppo \
    ...
    data.val_files=$DATA_DIR/valid_no_minerva.parquet \
    ...
    actor_rollout_ref.actor.fsdp_config.grad_offload=Fasle \
    ...
    trainer.total_epochs=2 > ./logs/${WANDB_PROJECT}-${EXP_NAME}.txt 2>&1
